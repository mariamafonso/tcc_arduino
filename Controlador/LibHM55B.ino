...
byte DIO_pin = 26;  //Pinos Din e Dout (1 e 2)
byte CLK_pin = 28;  //Pino Clk (4)
byte EN_pin = 30;   //Pino /EN (5)
...
void HM55B_CurrentCalibrationValues(){
  ...
  ***************************************************************/
  ...
  interpolTable[0] = 314.24;
  interpolTable[1] = 343.78;
  interpolTable[2] = 26.00;
  interpolTable[3] = 55.75;
  interpolTable[4] = 73.52;
  interpolTable[5] = 85.17;
  interpolTable[6] = 97.31;
  interpolTable[7] = 111.51;
  interpolTable[8] = 133.38;
  interpolTable[9] = 168.74;
  interpolTable[10] = 202.64;
  interpolTable[11] = 233.68;
  interpolTable[12] = 250.12;
  interpolTable[13] = 264.72;
  interpolTable[14] = 277.36;
  interpolTable[15] = 291.95;
}
